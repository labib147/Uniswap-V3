	...
	GraphQLHandlerMultipleHTTPConfiguration: {
		...
		properties: {
			...
			strategy: {
				...
				description: "Handling strategy (default: fallback) (Allowed values: fallback, race)"
			}
		},
		required: [
			"sources"
	...
	JsonSchemaHTTPOperation: {
		...
		properties: {
			...
			requestBaseBody: {
				...
				description: "This body will be merged with the request body sent with the underlying HTTP request"
			},
			responseSchema: {
				anyOf: [
					{
...
export { config as YamlConfig, jsonSchema };
