import { DocumentNode, GraphQLNamedType, GraphQLDirective, SchemaDefinitionNode, SchemaExtensionNode, GraphQLSchema, OperationTypeNode } from 'graphql';
...
export declare function buildTypeCandidates<TContext = Record<string, any>>({ subschemas, originalSubschemaMap, types, typeDefs, parseOptions, extensions, directiveMap, schemaDefs, mergeDirectives, }: {
