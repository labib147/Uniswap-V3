...
var _DefaultOptions = require("./statics/DefaultOptions");
...
class Interpolator {
  constructor(options = _DefaultOptions.defaultOptions) {
  ...
  registerBuiltInModifiers() {
    _modifiers.defaultModifiers.forEach(modifier => this.registerModifier(modifier.key, modifier.transform));
  ...
  parseRules(str) {
    ...
    const matches = str.match(execRegex); // const parsableMatches = matches.map((match) => ({ key: removeDelimiter(match), replaceWith: match }));
