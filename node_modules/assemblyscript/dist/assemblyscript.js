 ...
 */
var Xs=Object.defineProperty;var Vu=Object.getOwnPropertyDescriptor;var kd=Object.getOwnPropertyNames;var Pd=Object.prototype.hasOwnProperty;var Ks=(r,e)=>{for(var t in e)Xs(r,t,{get:e[t],enumerable:!0})},qs=(r,e,t,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of kd(e))!Pd.call(r,n)&&(t||n!=="default")&&Xs(r,n,{get:()=>e[n],enumerable:!(i=Vu(e,n))||i.enumerable});return r};var zu=(r,e,t,i)=>{for(var n=i>1?void 0:i?Vu(e,t):e,s=r.length-1,a;s>=0;s--)(a=r[s])&&(n=(i?a(e,t,n):a(n))||n);return i&&n&&Xs(e,t,n),n};var Bu={};Ks(Bu,{ASTBuilder:()=>Hs,ArrayLiteralExpression:()=>Ea,ArrowKind:()=>Ni,AssertionExpression:()=>ya,AssertionKind:()=>Gr,AtomicRMWOp:()=>Nu,BinaryExpression:()=>ga,BinaryModule:()=>Uu,BinaryOp:()=>$r,BlockStatement:()=>Ka,BrOnOp:()=>Zc,BreakStatement:()=>qa,CallExpression:()=>Ta,Class:()=>Ci,ClassDeclaration:()=>Hn,ClassExpression:()=>ba,ClassPrototype:()=>Is,CommaExpression:()=>Ia,CommentKind:()=>ma,CommentNode:()=>da,CommonFlags:()=>Pe,CommonNames:()=>w,CompiledExpression:()=>Ha,Compiler:()=>oi,ConditionKind:()=>Al,ConstantValueKind:()=>Ml,Constraints:()=>Xl,ConstructorExpression:()=>va,ContinueStatement:()=>Qa,DEFAULT_STACK_SIZE:()=>uS,DeclarationStatement:()=>We,DeclaredElement:()=>Gt,DecoratorFlags:()=>Q,DecoratorKind:()=>Et,DecoratorNode:()=>ha,DiagnosticCategory:()=>Bn,DiagnosticCode:()=>tt,DiagnosticEmitter:()=>ze,DiagnosticMessage:()=>Ri,DoStatement:()=>Za,Element:()=>Ts,ElementAccessExpression:()=>xa,ElementKind:()=>J,EmptyStatement:()=>ja,Enum:()=>wl,EnumDeclaration:()=>Ja,EnumValue:()=>Ul,EnumValueDeclaration:()=>$a,ExportDefaultStatement:()=>io,ExportImportStatement:()=>eo,ExportMember:()=>to,ExportNames:()=>ln,ExportStatement:()=>ro,Expression:()=>fe,ExpressionId:()=>nr,ExpressionRunnerFlags:()=>ws,ExpressionStatement:()=>no,ExternalKind:()=>Yl,FEATURE_BULK_MEMORY:()=>mS,FEATURE_EXCEPTION_HANDLING:()=>yS,FEATURE_EXTENDED_CONST:()=>RS,FEATURE_FUNCTION_REFERENCES:()=>xS,FEATURE_GC:()=>IS,FEATURE_MEMORY64:()=>vS,FEATURE_MULTI_VALUE:()=>bS,FEATURE_MUTABLE_GLOBALS:()=>fS,FEATURE_NONTRAPPING_F2I:()=>hS,FEATURE_REFERENCE_TYPES:()=>TS,FEATURE_RELAXED_SIMD:()=>SS,FEATURE_SIGN_EXTENSION:()=>_S,FEATURE_SIMD:()=>dS,FEATURE_TAIL_CALLS:()=>gS,FEATURE_THREADS:()=>ES,FalseExpression:()=>za,Feature:()=>Ot,FeatureFlags:()=>Ql,Field:()=>Qn,FieldDeclaration:()=>so,FieldFlags:()=>Rl,FieldPrototype:()=>Dl,File:()=>ys,FloatLiteralExpression:()=>Sa,Flow:()=>Ue,FlowFlags:()=>hs,ForOfStatement:()=>oo,ForStatement:()=>ao,Function:()=>je,FunctionDeclaration:()=>Wr,FunctionExpression:()=>Ra,FunctionPrototype:()=>Xe,FunctionTypeNode:()=>ca,GETTER_PREFIX:()=>kn,Global:()=>ti,INDEX_SUFFIX:()=>Le,INNER_DELIMITER:()=>ra,INSTANCE_DELIMITER:()=>vi,IdentifierExpression:()=>it,IdentifierHandling:()=>Ro,IfStatement:()=>lo,ImportDeclaration:()=>uo,ImportStatement:()=>zn,IndexSignature:()=>jn,IndexSignatureNode:()=>Xa,InstanceOfExpression:()=>Aa,IntegerLiteralExpression:()=>Na,Interface:()=>Jn,InterfaceDeclaration:()=>po,InterfacePrototype:()=>Bl,JSBuilder:()=>Ar,LIBRARY_PREFIX:()=>Ze,LIBRARY_SUBST:()=>On,LiteralExpression:()=>yt,LiteralKind:()=>we,Local:()=>De,LocalFlags:()=>ms,MemorySegment:()=>un,MethodDeclaration:()=>co,Module:()=>lt,ModuleDeclaration:()=>go,NamedTypeNode:()=>Vn,Namespace:()=>bs,NamespaceDeclaration:()=>_o,NewExpression:()=>La,Node:()=>P,NodeKind:()=>dt,NullExpression:()=>Ca,ObjectLiteralExpression:()=>Fa,OmittedExpression:()=>ka,OperatorKind:()=>Ce,Options:()=>Ps,PARENT_SUBST:()=>qd,PATH_DELIMITER:()=>Qe,Parameter:()=>Sc,ParameterKind:()=>Br,ParameterNode:()=>fa,ParenthesizedExpression:()=>Pa,Parser:()=>Es,Precedence:()=>he,Program:()=>gs,Property:()=>Zn,PropertyAccessExpression:()=>Oa,PropertyPrototype:()=>ri,Range:()=>se,RefAsOp:()=>Qc,RefIsOp:()=>Os,RegexpLiteralExpression:()=>wa,Relooper:()=>An,ReportMode:()=>Kn,Resolver:()=>qn,ReturnStatement:()=>fo,Runtime:()=>Fn,RuntimeFeatures:()=>Kl,SETTER_PREFIX:()=>Pn,SIMDExtractOp:()=>Lu,SIMDLoadOp:()=>ku,SIMDLoadStoreLaneOp:()=>Pu,SIMDReplaceOp:()=>Cu,SIMDShiftOp:()=>Fu,SIMDTernaryOp:()=>Ou,STATIC_DELIMITER:()=>xi,STUB_DELIMITER:()=>ia,SideEffects:()=>pn,Signature:()=>ve,Source:()=>zr,SourceKind:()=>Vr,State:()=>No,Statement:()=>le,StringLiteralExpression:()=>Ua,SuperExpression:()=>Da,SwitchBuilder:()=>Ms,SwitchCase:()=>ho,SwitchStatement:()=>mo,TSDBuilder:()=>Nr,Target:()=>Mr,TemplateLiteralExpression:()=>Ba,TernaryExpression:()=>Ma,ThisExpression:()=>Ga,ThrowStatement:()=>Eo,Token:()=>Yr,Tokenizer:()=>Xn,TrueExpression:()=>Va,TryStatement:()=>yo,Type:()=>u,TypeDeclaration:()=>To,TypeDefinition:()=>bt,TypeFlags:()=>wt,TypeKind:()=>ir,TypeName:()=>pa,TypeNode:()=>Wn,TypeParameterNode:()=>_a,TypeRef:()=>C,TypedElement:()=>Vt,Typeinfo:()=>bi,TypeinfoFlags:()=>Ii,UnaryExpression:()=>Yn,UnaryOp:()=>Ji,UnaryPostfixExpression:()=>Wa,UnaryPrefixExpression:()=>Ya,VariableDeclaration:()=>bo,VariableLikeDeclarationStatement:()=>Ai,VariableLikeElement:()=>ur,VariableStatement:()=>Io,VoidStatement:()=>vo,WhileStatement:()=>xo,addGlobalAlias:()=>iS,allocPtrArray:()=>me,buildJS:()=>$S,buildTSD:()=>JS,compile:()=>jS,createType:()=>Oe,diagnosticCategoryToColor:()=>Qu,diagnosticCategoryToString:()=>Dn,diagnosticCodeToString:()=>Ln,disableFeature:()=>NS,enableFeature:()=>AS,expandType:()=>Hl,featureToString:()=>wr,findDecorator:()=>gt,findUsedLocals:()=>st,formatDiagnostic:()=>Zu,formatDiagnosticMessage:()=>Zu,getBinaryLeft:()=>Me,getBinaryOp:()=>Jr,getBinaryRight:()=>Se,getBinaryenModuleRef:()=>eR,getBlockChildAt:()=>rn,getBlockChildCount:()=>tn,getBlockName:()=>en,getBreakCondition:()=>y2,getBreakName:()=>E2,getCallOperandAt:()=>Fe,getCallOperandCount:()=>at,getCallTarget:()=>ji,getConstValueF32:()=>Ye,getConstValueF64:()=>He,getConstValueI32:()=>ie,getConstValueI64High:()=>$e,getConstValueI64Low:()=>Be,getConstValueV128:()=>Zl,getDefaultParameterName:()=>Rc,getDependee:()=>QS,getDiagnosticCategory:()=>MS,getDiagnosticCode:()=>wS,getDiagnosticMessage:()=>US,getDiagnosticRange:()=>DS,getDiagnosticRelatedRange:()=>BS,getDropValue:()=>T2,getExpressionId:()=>te,getExpressionType:()=>ae,getFunctionBody:()=>v2,getFunctionName:()=>x2,getFunctionParams:()=>S2,getFunctionResults:()=>R2,getFunctionVars:()=>A2,getGlobalGetName:()=>$i,getGlobalInit:()=>C2,getGlobalName:()=>N2,getGlobalType:()=>L2,getIfCondition:()=>fs,getIfFalse:()=>jr,getIfTrue:()=>Zi,getLoadBytes:()=>Nl,getLoadOffset:()=>u2,getLoadPtr:()=>p2,getLocalGetIndex:()=>ot,getLocalSetIndex:()=>cs,getLocalSetValue:()=>lr,getLoopBody:()=>d2,getLoopName:()=>m2,getMemoryGrowDelta:()=>I2,getRangeEnd:()=>VS,getRangeSource:()=>zS,getRangeStart:()=>GS,getReturnValue:()=>b2,getSelectCondition:()=>g2,getSelectElse:()=>Fl,getSelectThen:()=>Cl,getSideEffects:()=>ai,getSource:()=>OS,getSourceNormalizedPath:()=>WS,getStoreBytes:()=>c2,getStoreOffset:()=>_2,getStorePtr:()=>f2,getStoreValue:()=>h2,getTagName:()=>F2,getTagParams:()=>k2,getTagResults:()=>P2,getUnaryOp:()=>Qi,getUnaryValue:()=>_s,initializeProgram:()=>ZS,isConstNonZero:()=>Je,isConstZero:()=>ge,isDeclaredElement:()=>nn,isError:()=>XS,isGlobalMutable:()=>jl,isIllegalVariableIdentifier:()=>Ao,isInfo:()=>YS,isLoadSigned:()=>Ll,isLocalTee:()=>qi,isTypeOmitted:()=>xe,isTypedElement:()=>Lo,isWarning:()=>HS,mangleInternalName:()=>Te,mangleInternalPath:()=>Li,mustPreserveSideEffects:()=>Gs,needsExplicitUnreachable:()=>Us,newOptions:()=>W2,newProgram:()=>kS,nextDiagnostic:()=>PS,nextFile:()=>qS,operatorTokenToString:()=>ye,optimize:()=>rR,parse:()=>KS,readString:()=>Ve,removeGlobalAlias:()=>nS,setBasenameHint:()=>CS,setBundleVersion:()=>cS,setExportMemory:()=>K2,setExportRuntime:()=>lS,setExportStart:()=>sS,setExportTable:()=>$2,setImportMemory:()=>q2,setImportTable:()=>J2,setInitialMemory:()=>Q2,setLowMemoryLimit:()=>oS,setMaximumMemory:()=>Z2,setMemoryBase:()=>tS,setNoAssert:()=>X2,setNoUnsafe:()=>aS,setOptimizeLevelHints:()=>LS,setPedantic:()=>FS,setRuntime:()=>H2,setSharedMemory:()=>j2,setSourceMap:()=>eS,setStackSize:()=>pS,setTableBase:()=>rS,setTarget:()=>Y2,tokenFromKeyword:()=>ju,tokenIsAlsoIdentifier:()=>Ju,typesToRefs:()=>Dr,typesToString:()=>Gn,util:()=>ua,validate:()=>tR});var q=typeof window<"u"&&window||typeof global<"u"&&global||self;if(typeof q.ASC_TARGET>"u"){let r=function(){Error.captureStackTrace?Error.captureStackTrace(this,r):this.stack=this.name+": "+this.message+`
...
`),V(i,--this.indentLevel),i.push(`))({}),
`),this.visitNamespace(e,t)}makeGlobalImport(e,t,i){var n=this.sb,s=i.type;V(n,this.indentLevel),ke(t)?n.push(t):(n.push('"'),n.push(de(t,34)),n.push('": '));let a=this.ensureModuleId(e);Rr(s,Lt.IMPORT)?(n.push(`(
...
`),V(n,--this.indentLevel),n.push("}")),n.push(`,
`)}makeFunctionImport(e,t,i,n=null){var s=this.sb,a=i.signature;if(V(s,this.indentLevel),ke(t)?s.push(t):(s.push('"'),s.push(de(t,34)),s.push('"')),Du(a,Lt.IMPORT)&&!n)s.push(`: (
...
`);for(let _=0,f=o.length;_<f;++_){let E=o[_];if(!Rr(E,Lt.EXPORT)){let g=i.getParameterName(_);V(s,this.indentLevel),s.push(g),s.push(" = "),this.makeLiftFromValue(g,E,s),s.push(`;
`)}}let p=new Array,c=this.ensureModuleId(e);n?(p.push(`(() => {
`),V(p,1),p.push(`// @external.js
`),Wh(n,1,p),p.push(`
})()`)):(e!="env"&&(p.push("__module"),p.push(c.toString()),p.push(".")),p.push(t),p.push("("),p.push(l.join(", ")),p.push(")")),n=p.join(""),p.length=0,Wh(n,this.indentLevel,p,!0),n=p.join(""),V(s,this.indentLevel),a.returnType!=u.void?(s.push("return "),this.makeLowerToValue(n,a.returnType,s),s.push(`;
`)):(s.push(n),s.push(`;
`)),V(s,--this.indentLevel),s.push("}")}s.push(`,
`)}visitFunction(e,t){if(!t.is(512)){var i=this.sb,n=t.signature;if(this.exports.push(e),!Du(n,Lt.EXPORT)){V(i,this.indentLevel),i.push(e),i.push("(");let s=n.parameterTypes,a=0;for(let p=0,c=s.length;p<c;++p)s[p].isInternalReference&&a++,p>0&&i.push(", "),i.push(t.getParameterName(p));i.push(`) {
`),V(i,++this.indentLevel),i.push("// "),i.push(t.internalName),i.push(n.toString()),i.push(`
`);let o=new Array;for(let p=0,c=s.length;p<c;++p){let _=s[p];if(!Rr(_,Lt.IMPORT)){let f=t.getParameterName(p);V(i,this.indentLevel),i.push(f),i.push(" = ");let E=_.isInternalReference&&--a>0;E&&(this.needsRetain=!0,this.needsRelease=!0,i.push("__retain("),o.push(f)),this.makeLowerToValue(f,_,i),E&&i.push(")"),i.push(`;
...
`);let o=s.length;for(let g=Map_keys(t),b=0,S=g.length;b<S;++b){let v=g[b],x=this.ensureModuleId(v),L=t.get(v);V(s,this.indentLevel),ke(v)?s.push(v):(s.push('"'),s.push(de(v,34)),s.push('"'));let O=s.length;s.push(": Object.assign(Object.create("),v=="env"?s.push("globalThis"):(s.push("__module"),s.push(x.toString())),s.push("), "),v=="env"&&s.push("imports.env || {}, "),s.push(`{
`),++this.indentLevel;let F=0;for(let k=Map_keys(L),B=0,Y=k.length;B<Y;++B){let z=k[B],X=assert(L.get(z));if(X.kind==5){let Z=X,ue=this.getExternalCode(Z);(!Du(Z.signature,Lt.IMPORT)||!ke(z)||ue)&&(this.makeFunctionImport(v,z,X,ue),++F)}else if(X.kind==0){let Z=X;(!Rr(Z.type,Lt.IMPORT)||!ke(z))&&(this.makeGlobalImport(v,z,Z),++F)}}--this.indentLevel,F?(V(s,this.indentLevel),s.push(`}),
`)):(s.length=O,v=="env"?s.push(": Object.assign(Object.create(globalThis), imports.env || {})"):(s.push(": __module"),s.push(x.toString())),s.push(`,
`))}--this.indentLevel;let l=s.length>o;l?(V(s,this.indentLevel),s.push(`};
`)):s.length=o-2;var p=this.importMappings,c=new Array;for(let g=Map_keys(p),b=0,S=g.length;b<S;++b){let v=g[b];if(v=="env")c.push(`  const env = imports.env;
`);else{let x=p.get(v);c.push("  const __module"),c.push(x.toString()),c.push(" = imports"),ke(v)?(c.push("."),c.push(v)):(c.push('["'),c.push(de(v,34)),c.push('"]')),c.push(`;
...
`)}if(this.needsLiftString){let g=i.OBJECTInstance,b=g.offsetof("rtSize")-g.nextMemoryOffset,S=1024;s.push(`  function __liftString(pointer) {
    if (!pointer) return null;
    const
    ...
    let
      start = pointer >>> 1,
      string = "";
    while (end - start > ${S}) string += String.fromCharCode(...memoryU16.subarray(start, start += ${S}));
...
`)}if(this.needsLowerArray){let g=i.arrayBufferInstance.id,b=i.arrayBufferViewInstance,S=b.nextMemoryOffset+4,v=b.offsetof("buffer"),x=b.offsetof("dataStart"),L=b.offsetof("byteLength"),O=L+4;s.push(`  function __lowerArray(lowerElement, id, align, values) {
    if (values == null) return 0;
    const
      length = values.length,
      buffer = exports.__pin(exports.__new(length << align, ${g})) >>> 0,
      header = exports.__pin(exports.__new(${S}, id)) >>> 0,
      memoryU32 = new Uint32Array(memory.buffer);
    memoryU32[header + ${v} >>> 2] = buffer;
    memoryU32[header + ${x} >>> 2] = buffer;
...
`)}if(this.needsLiftTypedArray){let g=i.arrayBufferViewInstance,b=g.offsetof("dataStart"),S=g.offsetof("byteLength");s.push(`  function __liftTypedArray(constructor, pointer) {
    if (!pointer) return null;
    const memoryU32 = new Uint32Array(memory.buffer);
    return new constructor(
      memory.buffer,
      memoryU32[pointer + ${b} >>> 2],
      memoryU32[pointer + ${S} >>> 2] / constructor.BYTES_PER_ELEMENT
    ).slice();
  }
`)}if(this.needsLowerTypedArray){let g=i.arrayBufferInstance.id,b=i.arrayBufferViewInstance,S=b.nextMemoryOffset,v=b.offsetof("buffer"),x=b.offsetof("dataStart"),L=b.offsetof("byteLength");s.push(`  function __lowerTypedArray(constructor, id, align, values) {
    if (values == null) return 0;
    const
      length = values.length,
      buffer = exports.__pin(exports.__new(length << align, ${g})) >>> 0,
      header = exports.__new(${S}, id) >>> 0,
      memoryU32 = new Uint32Array(memory.buffer);
    memoryU32[header + ${v} >>> 2] = buffer;
    memoryU32[header + ${x} >>> 2] = buffer;
    memoryU32[header + ${L} >>> 2] = length << align;
...
`),--this.indentLevel,assert(this.indentLevel==0),this.esm){s.push(`export const {
  `);for(let S=0,v=e.length;S<v;++S)S>0&&s.push(`,
  `),s.push(e[S]);s.push(`
...
`);let g=!1,b=new Array;for(let S=Map_keys(p),v=0,x=S.length;v<x;++v){let L=S[v];if(L=="env")V(s,2),s.push(`env: globalThis,
...
`),V(t,--this.indentLevel),t.push(`}
`),t.join("")}},Lt=(t=>(t[t.IMPORT=0]="IMPORT",t[t.EXPORT=1]="EXPORT",t))(Lt||{});function Rr(r,e){if(e==0){if(r.isIntegerValue&&r.size==64||r==u.bool)return!1}else if(r.isUnsignedIntegerValue&&r.size==32||r==u.bool)return!1;return!r.isInternalReference}function Du(r,e){var t=r.parameterTypes,i=e==0?1:0;for(let n=0,s=t.length;n<s;++n)if(!Rr(t[n],i))return!1;return!!Rr(r.returnType,e)}function Wh(r,e,t,i=!1){for(var n=0,s=r.length,a=0;a<s;)r.charCodeAt(a)==10&&(i?i=!1:V(t,e),t.push(r.substring(n,n=a+1))),++a;n<s&&(i||V(t,e),t.push(r.substring(n)))}var Nr=class extends Nn{constructor(e,t,i=!1){super(e,i);this.sb=[];this.indentLevel=0;this.seenObjectTypes=new Map;this.deferredTypings=new Array;this.esm=t}static build(e,t=!0){return new Nr(e,t).build()}visitGlobal(e,t){var i=this.sb,n=t.type,s=this.toTypeScriptType(n,hi.EXPORT);V(i,this.indentLevel),i.push("/** "),i.push(t.internalName),i.push(` */
...
`),V(i,this.indentLevel),i.push("export "),this.esm&&i.push("declare "),i.push("function "),i.push(e),i.push("(");var l=n.requiredParameters;for(let p=0;p<a;++p)p&&i.push(", "),i.push(t.getParameterName(p)),p>=l&&i.push("?"),i.push(": "),i.push(this.toTypeScriptType(s[p],hi.IMPORT));i.push("): "),i.push(this.toTypeScriptType(o,hi.EXPORT)),i.push(`;
...
`)}else t.push(`
`);V(t,this.indentLevel)}serializeParameter(e){var t=this.sb,i=e.parameterKind,n=e.implicitFieldDeclaration;n&&this.serializeAccessModifiers(n),i==2&&t.push("..."),this.visitIdentifierExpression(e.name);var s=e.type,a=e.initializer;s&&(i==1&&!a&&t.push("?"),xe(s)||(t.push(": "),this.visitTypeNode(s))),a&&(t.push(" = "),this.visitNode(a))}serializeExternalModifiers(e){var t=this.sb;e.is(2)?t.push("export "):e.is(1)?t.push("import "):e.is(4)&&t.push("declare ")}serializeAccessModifiers(e){var t=this.sb;e.is(4)&&t.push("declare "),e.is(256)?t.push("public "):e.is(512)?t.push("private "):e.is(1024)&&t.push("protected "),e.is(32)?t.push("static "):e.is(128)&&t.push("abstract "),e.is(64)&&t.push("readonly ")}finish(){var e=this.sb.join("");return this.sb=[],e}};var MG=Bu;export{Hs as ASTBuilder,Ea as ArrayLiteralExpression,Ni as ArrowKind,ya as AssertionExpression,Gr as AssertionKind,Nu as AtomicRMWOp,ga as BinaryExpression,Uu as BinaryModule,$r as BinaryOp,Ka as BlockStatement,Zc as BrOnOp,qa as BreakStatement,Ta as CallExpression,Ci as Class,Hn as ClassDeclaration,ba as ClassExpression,Is as ClassPrototype,Ia as CommaExpression,ma as CommentKind,da as CommentNode,Pe as CommonFlags,w as CommonNames,Ha as CompiledExpression,oi as Compiler,Al as ConditionKind,Ml as ConstantValueKind,Xl as Constraints,va as ConstructorExpression,Qa as ContinueStatement,uS as DEFAULT_STACK_SIZE,We as DeclarationStatement,Gt as DeclaredElement,Q as DecoratorFlags,Et as DecoratorKind,ha as DecoratorNode,Bn as DiagnosticCategory,tt as DiagnosticCode,ze as DiagnosticEmitter,Ri as DiagnosticMessage,Za as DoStatement,Ts as Element,xa as ElementAccessExpression,J as ElementKind,ja as EmptyStatement,wl as Enum,Ja as EnumDeclaration,Ul as EnumValue,$a as EnumValueDeclaration,io as ExportDefaultStatement,eo as ExportImportStatement,to as ExportMember,ln as ExportNames,ro as ExportStatement,fe as Expression,nr as ExpressionId,ws as ExpressionRunnerFlags,no as ExpressionStatement,Yl as ExternalKind,mS as FEATURE_BULK_MEMORY,yS as FEATURE_EXCEPTION_HANDLING,RS as FEATURE_EXTENDED_CONST,xS as FEATURE_FUNCTION_REFERENCES,IS as FEATURE_GC,vS as FEATURE_MEMORY64,bS as FEATURE_MULTI_VALUE,fS as FEATURE_MUTABLE_GLOBALS,hS as FEATURE_NONTRAPPING_F2I,TS as FEATURE_REFERENCE_TYPES,SS as FEATURE_RELAXED_SIMD,_S as FEATURE_SIGN_EXTENSION,dS as FEATURE_SIMD,gS as FEATURE_TAIL_CALLS,ES as FEATURE_THREADS,za as FalseExpression,Ot as Feature,Ql as FeatureFlags,Qn as Field,so as FieldDeclaration,Rl as FieldFlags,Dl as FieldPrototype,ys as File,Sa as FloatLiteralExpression,Ue as Flow,hs as FlowFlags,oo as ForOfStatement,ao as ForStatement,je as Function,Wr as FunctionDeclaration,Ra as FunctionExpression,Xe as FunctionPrototype,ca as FunctionTypeNode,kn as GETTER_PREFIX,ti as Global,Le as INDEX_SUFFIX,ra as INNER_DELIMITER,vi as INSTANCE_DELIMITER,it as IdentifierExpression,Ro as IdentifierHandling,lo as IfStatement,uo as ImportDeclaration,zn as ImportStatement,jn as IndexSignature,Xa as IndexSignatureNode,Aa as InstanceOfExpression,Na as IntegerLiteralExpression,Jn as Interface,po as InterfaceDeclaration,Bl as InterfacePrototype,Ar as JSBuilder,Ze as LIBRARY_PREFIX,On as LIBRARY_SUBST,yt as LiteralExpression,we as LiteralKind,De as Local,ms as LocalFlags,un as MemorySegment,co as MethodDeclaration,lt as Module,go as ModuleDeclaration,Vn as NamedTypeNode,bs as Namespace,_o as NamespaceDeclaration,La as NewExpression,P as Node,dt as NodeKind,Ca as NullExpression,Fa as ObjectLiteralExpression,ka as OmittedExpression,Ce as OperatorKind,Ps as Options,qd as PARENT_SUBST,Qe as PATH_DELIMITER,Sc as Parameter,Br as ParameterKind,fa as ParameterNode,Pa as ParenthesizedExpression,Es as Parser,he as Precedence,gs as Program,Zn as Property,Oa as PropertyAccessExpression,ri as PropertyPrototype,se as Range,Qc as RefAsOp,Os as RefIsOp,wa as RegexpLiteralExpression,An as Relooper,Kn as ReportMode,qn as Resolver,fo as ReturnStatement,Fn as Runtime,Kl as RuntimeFeatures,Pn as SETTER_PREFIX,Lu as SIMDExtractOp,ku as SIMDLoadOp,Pu as SIMDLoadStoreLaneOp,Cu as SIMDReplaceOp,Fu as SIMDShiftOp,Ou as SIMDTernaryOp,xi as STATIC_DELIMITER,ia as STUB_DELIMITER,pn as SideEffects,ve as Signature,zr as Source,Vr as SourceKind,No as State,le as Statement,Ua as StringLiteralExpression,Da as SuperExpression,Ms as SwitchBuilder,ho as SwitchCase,mo as SwitchStatement,Nr as TSDBuilder,Mr as Target,Ba as TemplateLiteralExpression,Ma as TernaryExpression,Ga as ThisExpression,Eo as ThrowStatement,Yr as Token,Xn as Tokenizer,Va as TrueExpression,yo as TryStatement,u as Type,To as TypeDeclaration,bt as TypeDefinition,wt as TypeFlags,ir as TypeKind,pa as TypeName,Wn as TypeNode,_a as TypeParameterNode,C as TypeRef,Vt as TypedElement,bi as Typeinfo,Ii as TypeinfoFlags,Yn as UnaryExpression,Ji as UnaryOp,Wa as UnaryPostfixExpression,Ya as UnaryPrefixExpression,bo as VariableDeclaration,Ai as VariableLikeDeclarationStatement,ur as VariableLikeElement,Io as VariableStatement,vo as VoidStatement,xo as WhileStatement,iS as addGlobalAlias,me as allocPtrArray,$S as buildJS,JS as buildTSD,jS as compile,Oe as createType,MG as default,Qu as diagnosticCategoryToColor,Dn as diagnosticCategoryToString,Ln as diagnosticCodeToString,NS as disableFeature,AS as enableFeature,Hl as expandType,wr as featureToString,gt as findDecorator,st as findUsedLocals,Zu as formatDiagnostic,Zu as formatDiagnosticMessage,Me as getBinaryLeft,Jr as getBinaryOp,Se as getBinaryRight,eR as getBinaryenModuleRef,rn as getBlockChildAt,tn as getBlockChildCount,en as getBlockName,y2 as getBreakCondition,E2 as getBreakName,Fe as getCallOperandAt,at as getCallOperandCount,ji as getCallTarget,Ye as getConstValueF32,He as getConstValueF64,ie as getConstValueI32,$e as getConstValueI64High,Be as getConstValueI64Low,Zl as getConstValueV128,Rc as getDefaultParameterName,QS as getDependee,MS as getDiagnosticCategory,wS as getDiagnosticCode,US as getDiagnosticMessage,DS as getDiagnosticRange,BS as getDiagnosticRelatedRange,T2 as getDropValue,te as getExpressionId,ae as getExpressionType,v2 as getFunctionBody,x2 as getFunctionName,S2 as getFunctionParams,R2 as getFunctionResults,A2 as getFunctionVars,$i as getGlobalGetName,C2 as getGlobalInit,N2 as getGlobalName,L2 as getGlobalType,fs as getIfCondition,jr as getIfFalse,Zi as getIfTrue,Nl as getLoadBytes,u2 as getLoadOffset,p2 as getLoadPtr,ot as getLocalGetIndex,cs as getLocalSetIndex,lr as getLocalSetValue,d2 as getLoopBody,m2 as getLoopName,I2 as getMemoryGrowDelta,VS as getRangeEnd,zS as getRangeSource,GS as getRangeStart,b2 as getReturnValue,g2 as getSelectCondition,Fl as getSelectElse,Cl as getSelectThen,ai as getSideEffects,OS as getSource,WS as getSourceNormalizedPath,c2 as getStoreBytes,_2 as getStoreOffset,f2 as getStorePtr,h2 as getStoreValue,F2 as getTagName,k2 as getTagParams,P2 as getTagResults,Qi as getUnaryOp,_s as getUnaryValue,ZS as initializeProgram,Je as isConstNonZero,ge as isConstZero,nn as isDeclaredElement,XS as isError,jl as isGlobalMutable,Ao as isIllegalVariableIdentifier,YS as isInfo,Ll as isLoadSigned,qi as isLocalTee,xe as isTypeOmitted,Lo as isTypedElement,HS as isWarning,Te as mangleInternalName,Li as mangleInternalPath,Gs as mustPreserveSideEffects,Us as needsExplicitUnreachable,W2 as newOptions,kS as newProgram,PS as nextDiagnostic,qS as nextFile,ye as operatorTokenToString,rR as optimize,KS as parse,Ve as readString,nS as removeGlobalAlias,CS as setBasenameHint,cS as setBundleVersion,K2 as setExportMemory,lS as setExportRuntime,sS as setExportStart,$2 as setExportTable,q2 as setImportMemory,J2 as setImportTable,Q2 as setInitialMemory,oS as setLowMemoryLimit,Z2 as setMaximumMemory,tS as setMemoryBase,X2 as setNoAssert,aS as setNoUnsafe,LS as setOptimizeLevelHints,FS as setPedantic,H2 as setRuntime,j2 as setSharedMemory,eS as setSourceMap,pS as setStackSize,rS as setTableBase,Y2 as setTarget,ju as tokenFromKeyword,Ju as tokenIsAlsoIdentifier,Dr as typesToRefs,Gn as typesToString,ua as util,tR as validate};
